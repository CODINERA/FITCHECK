...
Public Class Form6
    ...
    Private Sub Form6_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If count > 0 Then
                ...
                cmd1.Parameters.AddWithValue("@UserID", "3")
                ...
                'MessageBox.Show(Ex2)
            Else
                MessageBox.Show("Notice: You have no workout activity yet.")
            End If
            ...
            Try
                ...
                If count > 0 Then
                    ...
                    Using updateCmd As New MySqlCommand(updateQuery, sqlConn)
                        updateCmd.Parameters.AddWithValue("@UserID", "3")
                ...
                Else
                    ...
                    cmds.Parameters.AddWithValue("@UserID", "3")
                    ...
                    MessageBox.Show("Your workout progress have been saved successfully!")
                End If
    ...
    Private Sub Guna2TextBox1_TextChanged(sender As Object, e As EventArgs) Handles Guna2TextBox1.TextChanged
        Dim multiLineTextBox As New TextBox()
        multiLineTextBox.Multiline = True
        multiLineTextBox.Size = New Size(300, 100) ' Adjust width and height
        multiLineTextBox.ScrollBars = ScrollBars.Vertical ' Add vertical scroll bars
        multiLineTextBox.Location = New Point(10, 10) ' Set position on the form

        ' Add the text box to the form
        Me.Controls.Add(multiLineTextBox)
